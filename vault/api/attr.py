...
def node_create(project, name): 
  print __name__ + ".node_create("+project+","+name+") : [create node attribute for project]"
...
def edge_create(project, name): 
  print __name__ + ".edge_create("+project+","+name+") : [create edge attribute]"
